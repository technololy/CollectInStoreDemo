...
@__app_environment_variables_v_2.5 = internal constant [37 x i8] c"64fae947-9bd7-4454-84fb-40e764ab203b\00", align 16
...
@__ApplicationConfig_android_package_name.0 = internal constant [35 x i8] c"com.companyname.collectinstoredemo\00", align 16
...
@application_config = local_unnamed_addr constant %struct.ApplicationConfig {
	...
	i32 105, ; number_of_assemblies_in_apk
...
@__XamarinAndroidBundledAssembly_name_102 = internal global [67 x i8] zeroinitializer, align 16
@__XamarinAndroidBundledAssembly_name_103 = internal global [67 x i8] zeroinitializer, align 16
@__XamarinAndroidBundledAssembly_name_104 = internal global [67 x i8] zeroinitializer, align 16


; Bundled assembly name buffers, all 67 bytes long
@bundled_assemblies = local_unnamed_addr global [105 x %struct.XamarinAndroidBundledAssembly] [
	; 0
	...
	%struct.XamarinAndroidBundledAssembly {
		...
		i8* null, ; data
		i32 67, ; name_length
		i8* getelementptr inbounds ([67 x i8], [67 x i8]* @__XamarinAndroidBundledAssembly_name_102, i32 0, i32 0); name
	}, 
	; 103
	%struct.XamarinAndroidBundledAssembly {
		i32 -1, ; apk_fd
		...
		i8* null, ; data
		i32 67, ; name_length
		i8* getelementptr inbounds ([67 x i8], [67 x i8]* @__XamarinAndroidBundledAssembly_name_103, i32 0, i32 0); name
	}, 
	; 104
	%struct.XamarinAndroidBundledAssembly {
		i32 -1, ; apk_fd
		...
		i8* null, ; data
		i32 67, ; name_length
		i8* getelementptr inbounds ([67 x i8], [67 x i8]* @__XamarinAndroidBundledAssembly_name_104, i32 0, i32 0); name
	}
